document.addEventListener('DOMContentLoaded', () => {
  ...
  const renderInscripciones = (tutorias = [], schedules = [], usuarioId = '') => {
    ...
    inscritas.forEach(tutoria => {
      ...
      // Header / status (sin botón cancelar)
      ...
      info.innerHTML = `
        ...
        <div class="tutor-info-row">
          ...
          <div class="tutor-info-col">
            <div class="data-pair"><span class="label">Email del Tutor</span><span class="value" style="color: var(--ucab-link);">${escapeHtml(tutoria.creadorEmail || '')}</span></div>
          </div>
        </div>
      `;
      ...
      // Detalles inscripción (solo mostrar fecha)
      ...
      // Añadimos la tarjeta al grid (sin botones de cancelar ni links internos)
